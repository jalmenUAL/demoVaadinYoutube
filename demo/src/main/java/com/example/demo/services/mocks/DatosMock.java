...
public class DatosMock {
         ...
         * =========================================================
         *
         * Este objeto contiene el escenario de datos utilizado
         * durante la fase de prototipado.
         *
         * Los objetos son instancias de las mismas entidades JPA
         * que utilizará posteriormente la aplicación real, pero
         * en este caso se crean y mantienen en memoria.
         *
         * De esta forma, las vistas pueden desarrollarse y
         * comprobarse sin necesidad de disponer todavía de datos
         * persistidos en la base de datos.
         */

        public final Set<Youtuber> youtubers;
        public final Set<Video> videos;
        public final Set<Administrador> administradores;
         ...
         *
         * <p>
         * Los conjuntos se inicializan y, posteriormente,
         * se cargan los datos ficticios y sus relaciones.
         */
        public DatosMock() {
         ...
         *
         * <p>
         * Además de crear las entidades, se establecen algunas
         * de las relaciones entre ellas para disponer desde el
         * principio de un escenario suficientemente representativo
         * para las vistas.
         */
        private void cargarDatos() {
                ...
                /*
                 * Usuario administrador utilizado para poder
                 * probar las vistas y funcionalidades asociadas
                 * a este actor durante el prototipado.
                 */
                ...
                /*
                 * Los vídeos utilizan identificadores ficticios.
                 *
                 * En la aplicación real estos identificadores serán
                 * generados por JPA al persistir las entidades.
                 *
                 * Durante el prototipado se establecen manualmente
                 * para poder realizar operaciones como:
                 *
                 *     findVideoById(1)
                 *     borrarVideo(1)
                 *
                ...
                /*
                 * También se crean comentarios ficticios para que
                 * las vistas de comentarios dispongan de contenido
                 * desde el principio.
                 *
                 * Al igual que ocurre con los vídeos, los
                 * identificadores son ficticios y únicamente se
                 * utilizan durante el prototipado.
                 */
                ...
                c2.setTexto(
                        "Muy bien explicado, me ha servido mucho."
                );
                ...
                c3.setTexto(
                        "¿Podrías hacer otro vídeo sobre este tema?"
                );
                ...
                c5.setTexto(
                        "La explicación del final está genial."
                );
                ...
                c6.setTexto(
                        "No conocía esta forma de hacerlo."
                );
                ...
                c7.setTexto(
                        "Buen vídeo, gracias por compartirlo."
                );
                ...
                c8.setTexto(
                        "Me ha quedado mucho más claro ahora."
                );
                ...
                /*
                 * Se establecen las relaciones entre los Youtubers
                 * y los vídeos que han publicado.
                 */
                 ...
                 *
                 * Esta relación proporciona al AdministradorMock
                 * información que puede mostrar desde el principio.
                 */
         ...
         *
         * <p>
         * El identificador se establece manualmente porque,
         * durante el prototipado, el vídeo no se persiste en la BD
         * y, por tanto, JPA no genera su identificador.
         *
         * @param id identificador ficticio del vídeo
         * @param titulo título del vídeo
         * @param url URL del vídeo
         * @param youtuber Youtuber que publica el vídeo
         *
         * @return vídeo inicializado para el escenario Mock
         */
        private Video crearVideo(
                ...
                /*
                 * Identificador ficticio utilizado únicamente
